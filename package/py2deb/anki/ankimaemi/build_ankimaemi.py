...
if __name__ == "__main__":
     try:
         ...
         pass
     print
     p=py2deb.Py2deb("ankimaemi")   #This is the package name and MUST be in lowercase! (using e.g. "mClock" fails miserably...)
     p.description="Friendly, intelligent flashcards (simple program for reviewing).\n"\
     ".\n"\
     ...
     ".\n"\
     "This is the PyGTK GUI program for reviewing with anki.\n"\
     "It is very fast and has big finger friendly buttons.\n"\
     "For the full functionality as known from the desktop,\n"\
     "use the ankiqt program.\n"\
     ".\n"\
